...
https://coffeeorder-94399.web.app/
...
- ✅ **커밋 메시지 규칙**: `node build.js "Prefix : CommitLog"`
    ...
    - `fix` : 버그 수정
    - `feat` : 기능 추가 및 개선
    - `docs` : 문서 추가 및 수정 (코드 수정 X, 동작 영향 X, 버전 업데이트 제외)
    - `deploy` : 운영 환경 배포 (버전 업데이트 및 Firebase 배포 자동 수행)
...
- **개발자 이메일**: [devmcjo@gmail.com](mailto:devmcjo@gmail.com)
